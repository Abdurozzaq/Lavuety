(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["RegisterPage"],{
  ...
  methods: {
    register: function register() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.post('api/auth/register', {
        ...
        currentObj.email = "";
        currentObj.password = "";
        currentObj.password_confirmation = ""; // after success show successSnackbar
                              ...
                              _c(
                                ...
                                [
                                  _c("div", { staticClass: "text-h6" }, [
                                    _vm._v("Welcome! you're new, right?")
                                  ]),
                                  _vm._v(" "),
                                  _c(
                                    "div",
                                    { staticClass: "text-subtitle1 pb-3" },
                                    [_vm._v("Let's Create An Account")]
                                  )
                                ]
                              ),
                              _vm._v(" "),
